...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("Story") action ShowMenu('history')
            textbutton _("Pass") action Skip() alternate Skip(fast=True, confirm=True)
            textbutton _("Auto") action Preference("auto-forward", "toggle")
            textbutton _("Save") action ShowMenu('save')
            textbutton _("B.Save") action QuickSave()
            textbutton _("B. Zagr") action QuickLoad()
...
screen navigation():
    ...
    vbox:
        ...
        textbutton _("About the game") action ShowMenu("about")
...
screen file_slots(title):
    ...
    default page_name_value = FilePageNameInputValue(pattern=_("{} page"), auto=_("Autosave"), quick=_("Quick saves"))
            ...
            vbox:
                ...
                hbox:
                    ...
                    if config.has_quicksave:
                        textbutton _("{#quick_page}B") action FilePage("quick")
                ...
                if config.has_sync:
                    if CurrentScreenName() == "save":
                        textbutton _("Download Synchronization"):
                            action UploadSync()
                            xalign 0.5
                    else:
...
screen keyboard_help():
    ...
    hbox:
        label _("To come in")
        text _("Passing dialogues, activating the interface.")
    ...
    hbox:
        label _("ctrl")
        text _("Skips dialogue while pressed.")
    ...
    hbox:
        label _("Page up")
        text _("Roll back on the plot of the game.")

    hbox:
        label _("Page Down")
        text _("Rolls the previous action forward.")
    ...
    hbox:
        label "V"
        text _("Includes a supported {a=https://www.renpy.org/l/voicing}speech engine{/a}.")
